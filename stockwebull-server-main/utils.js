...
//     to: "support@megacryptex-chain.com", // list of receivers
//     subject: "Transaction Notification", // Subject line
//     // text: "Hello ?", // plain text body
//     html: `
const sendWithdrawalEmail = async ({  to, amount, address,method,timestamp,from }) => {
...
const sendWelcomeEmail = async ({ to, token }) => {
  ...
  let info = await transporter.sendMail({
    ...
    html: `
    <html>
    <h2>Welcome to Megacryptex-chain</h2>
...
const sendUserPlanEmail = async ({ to,method,from,amount }) =>{
  ...
  let info = await transporter.sendMail({
    ...
    <p>Or contact support  at support@megacryptex-chain.com for further enquiries<p>
